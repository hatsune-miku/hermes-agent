...
class HermesCLI:
    ...
    def run(self):
        ...
        # --- Input processors for inline placeholder ---
        ...
        def _get_placeholder():
            ...
            if cli_ref._sudo_state:
                return "type password, Enter to submit · ESC to skip"
            if cli_ref._secret_state:
                return "type secret, Enter to submit · ESC to skip"
        ...
        def get_hint_text():
            if cli_ref._sudo_state:
                ...
                return [
                    ('class:hint', '  password visible · Enter to skip'),
            ...
            if cli_ref._secret_state:
                ...
                return [
                    ('class:hint', '  secret visible · Enter to skip'),
                    ('class:clarify-countdown', f'  ({remaining}s)'),
                ]
        ...
        def _get_sudo_display():
            ...
            body = 'Enter password below (visible), or press Enter to skip'
        ...
        def _get_secret_display():
            ...
            body = 'Enter secret below (visible), ESC or Ctrl+C to skip'
