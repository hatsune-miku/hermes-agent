...
def _prompt_for_sudo_password(timeout_seconds: int = 45) -> str:
    ...
    so the prompt integrates with prompt_toolkit's UI. Otherwise reads visible
    terminal input.
    """
    import sys
    ...
    def read_password_thread():
        """Read password from the console/tty with normal terminal echo."""
        tty_fd = None
        try:
    ...
    try:
        ...
        print("├" + "─" * 58 + "┤")
        print("│  Enter password below (input is visible), or:           │")
